...
$special_pages = array(
    __('aviso-de-privacidad',TRANSDOMAIN)	 => array(
            __('Aviso de privacidad',TRANSDOMAIN)	, // nombre de la pagina
            "" // slug de de la pagina padre siempre se debe registar la pagina padre
        ) ,
    __('niveles-educativos-lactantes',TRANSDOMAIN)	 => array(
            __('Niveles Educativos Lactantes',TRANSDOMAIN)	, // nombre de la pagina
            "" // slug de de la pagina padre siempre se debe registar la pagina padre
        ) ,
    __('niveles-educativos-preescolar',TRANSDOMAIN)	 => array(
            __('Niveles Educativos Preescolar',TRANSDOMAIN)	, // nombre de la pagina
            "" // slug de de la pagina padre siempre se debe registar la pagina padre
        ) ,

    __('filosofia-de-la-escuela' ,TRANSDOMAIN)	=> array(
            __('Filosofía de la escuela',TRANSDOMAIN)	, // nombre de la pagina
            "" // slug de de la pagina padre siempre se debe registar la pagina padre
        ) ,
    __('servicios-y-beneficios',TRANSDOMAIN)	 => array(
            __('Servicios y beneficios',TRANSDOMAIN), // nombre de la pagina
            "" // slug de de la pagina padre siempre se debe registar la pagina padre
        ) ,
    __('contacto',TRANSDOMAIN)	 => array(
            __('Contacto',TRANSDOMAIN)	,  // nombre de la pagina
            ""  // slug de de la pagina padre siempre se debe registar la pagina padre
        ),
    __('home',TRANSDOMAIN)	 => array(
            __('Home',TRANSDOMAIN)	,  // nombre de la pagina
            ""  // slug de de la pagina padre siempre se debe registar la pagina padre
        ),
);
