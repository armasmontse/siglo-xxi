...
class Cltvo_Contacto_Documents extends Cltvo_Metabox_Master
{
     ...
     */
    protected $description_metabox = "Documentos";
	...
	public function CltvoDisplayMetabox( $object ){
        $this->printSingleItemRepiterList([],"Fotocopia del acta de...");
	}
}
