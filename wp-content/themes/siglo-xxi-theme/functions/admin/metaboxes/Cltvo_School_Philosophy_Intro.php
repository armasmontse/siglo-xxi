...
class Cltvo_School_Philosophy_Intro extends Cltvo_Metabox_Master
{
            ...
            .ancho_100{
        		...
        		<table class="ancho_100" >
        			<tr>
                        ...
                        <td>
        					<input type="text" placeholder="LÓGICA, CREATIVIDAD..." name="<?php echo  $this->meta_key; ?>[title]" id="<?php echo  $this->meta_key; ?>[title]" value="<?php echo $this->meta_value['title']; ?>" class="ancho_100" />
        				</td>
        			</tr>
        			<tr>
        				<td>
